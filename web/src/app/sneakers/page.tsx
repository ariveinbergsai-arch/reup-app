    ...
    <main className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-zinc-400">
              ...
              <Link href="/sneakers" className="text-white">Sneakers</Link>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-gradient-to-r from-zinc-900 to-zinc-800 rounded-2xl p-8 mb-8">
          <h1 className="text-4xl font-bold mb-2">Sneakers</h1>
          <p className="text-zinc-400">Shop authentic pre-owned sneakers and footwear</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h2 className="text-xl font-semibold mb-2">No sneakers listed yet</h2>
          <p className="text-zinc-500 mb-6 max-w-md">
            Be the first to list sneakers on REUP. Sell your authentic pre-owned kicks today.
          </p>
          <Link
            href="/sell"
